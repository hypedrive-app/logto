const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'A tenant is an isolated environment where you can manage user identities, applications, and all other Hypedrive resources.',
    invite_collaborators: 'Invite your collaborators by email',
  },
  social_callback: {
    title: "You've successfully signed in",
    description:
      'You have successfully signed in using your social account. To ensure seamless integration and access to all the features of Hypedrive, we recommend that you proceed to configure your own social connector.',
    notice:
