const roles = {
  ...
  management_api_access_notification:
    'For Hypedrive Management API access, select roles with Management API permissions <flag/>.',
  with_management_api_access_tip:
    'This machine-to-machine role includes Hypedrive Management API permissions',
