...
// Sign-in via email verification code is enabled, but email is NOT a sign-up identifier (username-only
// registration). So an unregistered email has no path to become a user and should not receive a code.
