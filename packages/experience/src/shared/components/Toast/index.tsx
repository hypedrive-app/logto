...
const Toast = ({ message, duration = 3000, callback }: Props) => {
  ...
  return (
    <ReactModal
      ...
      className="mx-auto py-2.5 px-4 max-w-[min(320px,calc(100vw-32px))] text-[15px] font-medium leading-snug text-white rounded-[var(--radius-md)] bg-[var(--color-bg-toast)] text-center break-words pointer-events-auto focus-visible:outline-none shadow-[var(--sh-float)] desktop:py-3"
      closeTimeoutMS={300}
    >
      {text}
    </ReactModal>
